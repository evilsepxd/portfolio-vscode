import{r as v,v as O}from"./index-210abfee.js";(function(n){if(!n||typeof window>"u")return;const s=document.createElement("style");s.setAttribute("type","text/css"),s.innerHTML=n,document.head.appendChild(s)})(`.main-highlighter-relative {
  position: relative;
  width: 100%;
  background: #1e1e1e;
  padding: 20px;
