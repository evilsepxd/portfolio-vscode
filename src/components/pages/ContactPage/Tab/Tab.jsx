...
import { clearForm } from "../contactSlice";

function Tab() {
	const dispatch = useDispatch();

	return (
		<div className="tabs tabs_contact">
			<div className='tabs__item'>
				<div className="tabs__text">contacts</div>
				<button className="tabs__icon" onClick={() => dispatch(clearForm())}>
